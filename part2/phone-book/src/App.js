...
const App = () => {
  ...
  const filterPersons = (e) => {
    if(e.target.value !== '') {
      setNewFiltered(
        {
          array: persons.filter(
            val => val.name.toUpperCase().includes(
  ...
  return (
    <div>
      ...
      <Form submitForm={submitForm} valueName={newName} changeName={nameChangeHandler} valueNumber={newNumber} changeNumber={numberChangeHandler} />
